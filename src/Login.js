  ...
  return (
    <div style={{ minHeight:"100vh", background:"#0a0e1a", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"sans-serif" }}>
      <div style={{ background:"#111827", borderRadius:16, padding:32, width:"100%", maxWidth:380, border:"1px solid #1e293b" }}>
        <h1 style={{ textAlign:"center", fontSize:"1.8rem", fontWeight:800, background:"linear-gradient(90deg,#38bdf8,#818cf8)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", marginBottom:8 }}>💳 FinanControl</h1>
        <p style={{ textAlign:"center", color:"#64748b", fontSize:"0.85rem", marginBottom:28 }}>Controle financeiro familiar</p>
